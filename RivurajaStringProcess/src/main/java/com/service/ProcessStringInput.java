...
public class ProcessStringInput {
	...
	/**
	 * Process String to provide the maximum distance between two characters in a String
	 */
	...
	/**
	 * Business logic for calculation of max distance between two occurrences of characters
	 * @param input1
	 * @param input2
	...
	public int calculateMaximumCharacterDistance(String inputStringValue, String checkCharacter) {
		...
		String[] output = buffer.toString().split(checkCharacter);
		
		//if there are less than two occurrences of character return -1
		if(output.length<3)
			return -1;
